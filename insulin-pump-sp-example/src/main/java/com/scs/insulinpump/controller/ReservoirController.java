...
import com.scs.insulinpump.service.ReservoirService;
...
public class ReservoirController {
    ...
    public @ResponseBody Double getInsulinLevel(@PathVariable Integer patientId) {
    ...
    public @ResponseBody Double getGlucagonLevel(@PathVariable Integer patientId) {
        if(patientId == null) return null;
